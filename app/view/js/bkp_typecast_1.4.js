	...
	Behaviours : {
		Mask : {
			...
			InitField : function(field){
				var fieldData = [];
				var TCMask		= field.className.substring(field.className.indexOf("[")+1, field.className.indexOf("]"));
				//if ((TCMask.indexOf(Typecast.Config.Settings.Mask.MaskCharacters.Numeric) == -1) && (TCMask.indexOf(Typecast.Config.Settings.Mask.MaskCharacters.Alpha) == -1)) {
