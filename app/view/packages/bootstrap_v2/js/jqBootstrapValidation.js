        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("minchecked") !== undefined) {
              message = "Número de opções marcadas é insulficiente; mínimo de '" + $this.attr("minchecked") + "' exigido<!-- data-validation-minchecked-message to override -->";
            ...
            if ($this.attr("maxchecked") !== undefined) {
              message = "Muitas opções marcadas; Máximo de '" + $this.attr("maxchecked") + "' exigido<!-- data-validation-maxchecked-message to override -->";
      ...
      ajax: {
		...
		builtInValidators: {
			...
			dataBR: {
				...
				message: "Data deve ter o formato dd/mm/yyyy"
			},
			passwordagain: {
				name: "Passwordagain",
				type: "match",
			...
			required: {
				name: "Required",
				type: "required",
				message: "É obrigatório<!-- data-validator-required-message to override -->"
			},
			checkone: {
				name: "Checkone",
				type: "minchecked",
